...
| TOOL002-I | IN_PROGRESS | D076 Candidate D, D077 Candidate D, D087 Candidate B, D091 Candidate A′, D094 Candidate A′ refined, D097 Candidate B′, D098 Candidate A′, D099 Candidate A′ refined and D101 Candidate C′ are RATIFIED. I1-I7A and I7B1 are CLOSED. I7B1 materializes bundled-Protos ownership of D099 `--resource-catalog PATH` selection in `Options.protos`: absence returns null, one occurrence preserves the exact PATH token, and missing/repeated occurrences fail closed while D069 `--jobs` remains unchanged. I7B2 is next: install the Test-Tool-private one-shot host catalog-acquisition capability returning immutable Bytes. Public Main composition remains I7B3; D076 reservation/provisioning, provider implementation/loading, physical topology, remote transport and public `std:toml` remain outside this slice. |
