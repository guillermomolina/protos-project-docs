...
| TOOL002-I | IN_PROGRESS | D076 Candidate D, D077 Candidate D, D087 Candidate B, D091 Candidate A′, D094 Candidate A′ refined, D097 Candidate B′, D098 Candidate A′, D099 Candidate A′ refined, D101 Candidate C′, D105 Candidate E′, D107 Candidate D′ and D108 Candidate C′ are RATIFIED. I1-I7A, I7B1, I7B2, I7B3A, I7B3B, I8A, I8B, I8C, I8D1, I8D2 and I8D3 are CLOSED. D108 closes the I8D4 infrastructure-outcome/terminal-cleanup gate with one terminally-closed dual-lane attempt envelope: guest observation and infrastructure outcome remain distinct; a resourceful attempt completes only after provider provisioning/rollback disposition, guest execution if started, real Process plus execution-host/Context terminalization, reverse-order all-attempted ProviderLease cleanup, and safe-capacity determination. Infrastructure failure never becomes guest `Error`. I8B reservation release requires confirmed safe reuse; unsafe/unconfirmed capacity remains held. If any attempt in an admitted D105 resource round has infrastructure failure, all already-admitted siblings drain to their own terminal boundary, safe reservations release, unsafe reservations remain held, then the invocation fail-stops before H-window rescan or later-window admission; later resource-free tests are not continued in this baseline. Guest observations already produced remain evidence; provisioning failures or never-started cases do not fabricate guest failures. Fault-domain quarantine/continuation, retries, timeout/kill, preemption and distributed recovery remain deferred. The next bounded executable slice may implement I8D4 private terminal lifecycle/envelope/round-drain composition; public Main/I6E wiring remains later. |
