...
| TOOL002-I | IN_PROGRESS | D076 Candidate D, D077 Candidate D, D087 Candidate B, D091 Candidate A′, D094 Candidate A′ refined, D097 Candidate B′, D098 Candidate A′, D099 Candidate A′ refined and D101 Candidate C′ are RATIFIED. I1-I7A, I7B1 and I7B2 are CLOSED. I7B2 installs the D101 Test-Tool-private bootstrap-local `catalogAcquirer` native capability: it captures the invocation working directory, consumes authority on the first attempt, accepts exactly one selected String PATH, follows ordinary symlinks, requires a readable regular final target, acquires complete content once and returns a frozen Bytes snapshot. It is not a Filesystem and is not present in independent/child module activations. I7B3 is next: public Main composes I7B1 option selection with this capability, UTF-8 decoding and I7A parsing. D076 reservation/provisioning, provider implementation/loading, physical topology, remote transport and public `std:toml` remain outside I7B2. |
