...
| TOOL002-I | IN_PROGRESS | D076 Candidate D, D077 Candidate D, D087 Candidate B, D091 Candidate A′, D094 Candidate A′ refined, D097 Candidate B′, D098 Candidate A′, D099 Candidate A′ refined, D101 Candidate C′, D105 Candidate E′, D107 Candidate D′, D108 Candidate C′, D113 Candidate B′ and D114 Candidate B′ are RATIFIED. I1-I7A, I7B1, I7B2, I7B3A, I7B3B, I8A, I8B, I8C, I8D1, I8D2, I8D3, I8D4A, I8D4B, I8D4C1, I8D4C2 and I8D4C3 are CLOSED. I8D4C3 closes the private D108 Runner composition: complete admitted-round terminal drain, SAFE-only I8B release, UNSAFE reservation retention, preserved guest evidence, exact infrastructure-attempt evidence, cutover-not-admitted CaseSpecs and whole-invocation fail-stop. D113 now fixes production provider composition as one explicit immutable invocation-scoped host-bootstrap registry from logical provider IDs to configured transport-neutral adapters, with an empty registry valid/default, exact fail-closed lookup, no ambient discovery, and provider implementation/configuration/secrets remaining host-owned. D114 now fixes public Test Tool run outcome as an outer tagged TestRunOutcome: healthy `completed` retains the historical `runTuple`; `infrastructure-aborted` preserves executed CaseRuns, ordinary unsupported count, per-attempt infrastructure evidence, exact cutover-not-admitted CaseSpecs and retained unsafe-reservation count without fabricating guest failure/skip. CLI classification is 0 healthy success, 1 completed guest/test failure, existing 2 usage error, 3 infrastructure-aborted and existing 70 unexpected/internal failure. Infrastructure diagnostics are bounded/sanitized, retained unsafe capacity is invocation-local evidence only, and future event streaming remains additive. Public Main/CLI provider+reporting integration is now released for bounded implementation; this ratification itself changes no executable code or implementation version. |
