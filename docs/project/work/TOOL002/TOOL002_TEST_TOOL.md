...
| TOOL002-I | IN_PROGRESS | D076 Candidate D, D077 Candidate D, D087 Candidate B, D091 Candidate A′, D094 Candidate A′ refined, D097 Candidate B′, D098 Candidate A′, D099 Candidate A′ refined, D101 Candidate C′, D105 Candidate E′, D107 Candidate D′, D108 Candidate C′, D113 Candidate B′, D114 Candidate B′ and D116 Candidate B′ are RATIFIED. I1-I7A, I7B1, I7B2, I7B3A, I7B2, I7B3A, I7B3B, I8A, I8B, I8C, I8D1, I8D2, I8D3, I8D4A, I8D4B, I8D4C1, I8D4C2, I8D4C3, I8D5A and I8D5B are CLOSED. I8D5A materializes the D113 host-bootstrap boundary with an explicit immutable empty provider registry and production C1/C2 resource execution routes. I8D5B adds the D114 pure Protos-side projection from the private C3 D108 envelope to the outer tagged TestRunOutcome while preserving the historical primary runTuple. D116 now fixes invocation-wide completed classification: every actually executed Test Tool-owned plan contributes its existing guest/test result to final completed success/failure, while each plan-local runTuple remains local and the historical primary runTuple remains the healthy D114 compatibility payload. The primary plan is primary for payload compatibility only, not exclusive exit authority. Completed all-healthy => exit 0; completed failure in any executed owned plan => exit 1; D114 infrastructure-aborted retains precedence => exit 3 while preserving prior guest/test evidence. Bundled Protos owns the N-plan aggregation policy; Java may consume only the already-decided classification. Future richer multi-plan/event reporting remains additive. I8D5C is READY for the atomic public Main/CLI cutover under D113/D114/D116. |
