...
| TOOL002-I | IN_PROGRESS | D076 Candidate D, D077 Candidate D, D087 Candidate B, D091 Candidate A′, D094 Candidate A′ refined, D097 Candidate B′, D098 Candidate A′, D099 Candidate A′ refined and D101 Candidate C′ are RATIFIED. I1-I7A are CLOSED. I7B is the next bounded executable slice: bundled Protos owns D099 `--resource-catalog` policy through `process.args()`, while the host supplies one Test-Tool-private one-shot catalog-acquisition capability that returns immutable Bytes only; no broad host Filesystem authority, Java-owned duplicate CLI policy, D076 reservation/provisioning, provider implementation/loading, physical topology, remote transport or public `std:toml` is included by D101. |
