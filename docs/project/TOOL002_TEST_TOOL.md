...
| TOOL002-F | IN_PROGRESS | F1/F2/F3A/F3B/F3C/F3D are CLOSED; F3E integration is READY and F4 remains dependency-gated. |
...
| TOOL002-F3 | IN_PROGRESS | F3A/F3B/F3C/F3D are CLOSED; retained stored/fresh evidence is complete and final F3E integration is READY. |
...
| TOOL002-F3E | READY | F3D CLOSED; integrate stored/fresh parsing/evaluation and negative cases, close F3, and make F4 READY without activating `future-*` in public `runSimple`. |
