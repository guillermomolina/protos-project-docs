...
| TOOL002-F | IN_PROGRESS | F1/F2/F3A/F3B/F3C/F3D are CLOSED; F3E is IN_PROGRESS with E1/E2/E3A CLOSED and E3B READY; F4 remains dependency-gated. |
...
| TOOL002-F3 | IN_PROGRESS | F3A/F3B/F3C/F3D are CLOSED; F3E has parser, positive fresh evaluation and unified private stored/fresh composition CLOSED; integrated negatives are READY. |
...
| TOOL002-F3E | IN_PROGRESS | E1 parser + E2 positive fresh evaluator + E3A unified private composition CLOSED; E3B integrated negatives READY; E4 remains dependency-ordered before F4. |
...
| TOOL002-F3E3B | READY | After E3A, add integrated malformed/mismatch negative policy without changing public `runSimple`. |
