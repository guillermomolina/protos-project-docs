...
| TOOL001-F2E3 | external-node execution-plan construction | READY | D053 RATIFIED | D053 ratifies generation 2 as one mixed inert workspace/registry/Git graph; generation 1 remains semantically frozen workspace-only. External package nodes carry ContentIdentity once, typed refs remain compact, dependency edges remain uniform, and provenance/custody/host authority stay outside the plan. |
