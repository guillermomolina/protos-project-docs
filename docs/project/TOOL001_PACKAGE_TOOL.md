...
| TOOL001-F2E | external immutable-package execution continuation | IN_PROGRESS | F2E0/F2E1 CLOSED; I024/B009 CLOSED | ContentIdentity is CLOSED and the general D046 capture/observation implementation plus conformance are CLOSED; F2E2 is IN_PROGRESS through the new decomposition; F2E2A is READY. |
