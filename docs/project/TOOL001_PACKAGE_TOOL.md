...
| TOOL001-F2D3B1B2 | exact member-location directory binding | IN_PROGRESS | TOOL001-F2D3B1B2A/F2D3B1B2B published | Exact child lookup + confined canonical traversal CLOSED; final immutable package-directory binding remains. |
...
| TOOL001-F2D3B1B2C | immutable package -> physical-directory binding | READY | — | Apply the closed traversal to the detached B1B1 package index and produce exact immutable package-directory bindings. |
