...
| TOOL001-F2D3B | exact workspace package-backed module resolver | IN_PROGRESS | TOOL001-F2D3B1A/F2D3B1B2 published | Key identity + exact package-directory binding CLOSED; B1B3 source lookup READY; routing remains dependency-gated. |
| TOOL001-F2D3B1 | package identity + source mechanism | IN_PROGRESS | TOOL001-F2D3B1A/F2D3B1B2 published | Canonical key + exact package-directory binding CLOSED; logical source-file mapping remains. |
...
| TOOL001-F2D3B1B | physical source mechanism | IN_PROGRESS | TOOL001-F2D3B1B1/F2D3B1B2 published | Root/index + exact member-directory binding CLOSED; logical-module source binding READY. |
...
| TOOL001-F2D3B1B3 | logical module -> exact regular `.protos` source | READY | — | Map portable logical segments beneath an already-bound package directory to one exact-case regular confined source file. |
