...
| TOOL001-C5 | package-tool manifest Slice 3C | IN_PROGRESS | TOOL001-C5A/C5B/C5C published | Cost-aware schema-v1 implementation parent. C5A removes manifest-scale parser stack growth; C5B closes the stable mandatory base; C5C closes compatibility/exports/workspace; C5D dependency declarations and final schema-v1 closure are READY. |
...
| TOOL001-C5D | package-tool manifest Slice 3C3 | READY | — | Dependency alias declarations, registry/Git/path exclusivity, complete ManifestV1 construction, cross-schema conformance and final C5 closure. |
...
| TOOL001-C | historical manifest Slice 3 parent | IN_PROGRESS | C1/C2/C3/C4 plus C5A/C5B/C5C published | Canonical TOML parsing, the mandatory schema base and optional compatibility/exports/workspace sections are closed; continue C5D dependencies/final schema, then C6 read/diagnostics and C7 final closure. |
