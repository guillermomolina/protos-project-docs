...
| TOOL001-C5 | package-tool manifest Slice 3C | IN_PROGRESS | TOOL001-C5A/C5B published | Cost-aware schema-v1 implementation parent. C5A removes manifest-scale parser stack growth; C5B closes the stable root/manifest-version/package base helper; C5C compatibility/exports/workspace is READY and C5D dependencies/final schema closure remains dependency-ordered. |
...
| TOOL001-C5C | package-tool manifest Slice 3C2 | READY | — | Validate/model `compatibility`, `exports` and `workspace` over the stable C5B base, including fail-closed fields and duplicate-free members. |
...
| TOOL001-C | historical manifest Slice 3 parent | IN_PROGRESS | C1/C2/C3/C4 plus C5A/C5B published | Canonical TOML parsing and the schema-v1 mandatory base are closed; continue C5C optional sections, C5D dependencies/final schema, then C6 read/diagnostics and C7 final closure. |
