...
| TOOL001-F2E3 | external-node execution-plan construction | BLOCKED_BY_DECISION | D053 NEEDS_USER_DECISION | F2E2 is closed, but the F2E3 audit exposed a durable PackageExecutionPlan ABI-evolution choice. D053 owns generation compatibility and external-node representation; no extended plan implementation may publish before ratification. |
