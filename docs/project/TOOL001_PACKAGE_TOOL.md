...
| TOOL001-F2D3B | exact workspace package-backed module resolver | IN_PROGRESS | TOOL001-F2D3B1 published | Package identity + exact source mechanism CLOSED; B2 routing READY. |
...
| TOOL001-F2D3B2 | resolver routing | READY | — | Key + source mechanism are closed; routing may begin with self:. |
| TOOL001-F2D3B2A | self: routing | READY | — | First observable package import routing slice after complete key + source mechanism; prefer Protos-source behavior tests. |
