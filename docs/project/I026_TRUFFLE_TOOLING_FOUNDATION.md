...
| I026-D | IN_PROGRESS | `0.2.319-SNAPSHOT` | I026-A1 + PLAT013 | D1 publishes ordinary Object local-member interop; D2 publishes exact String/Boolean/null scalar facets; D2A closes their PLAT013 host-opaque display obligation. Numeric, Array and remaining safe runtime-family facets stay in D. |
