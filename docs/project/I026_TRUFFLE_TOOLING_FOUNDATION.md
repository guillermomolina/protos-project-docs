...
| I026-C | READY | — | I026-B + PLAT005 + PLAT008 | Implement ratified PLAT005 semantic-minimum instrumentation together with PLAT008 wrapper-transparent logical replay identity: direct-`CanonicalSequence` `StatementTag`, Call/Send/SuperSend `CallTag`, recursive wrapper-to-delegate replay normalization, and no duplicate completed-replay events; keep root/expression/value/yield surfaces deferred. |
