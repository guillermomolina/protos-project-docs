...
| I026-A4B3 | IN_PROGRESS | — | I026-A4B2 | Production-driver cutover is partially published: ordinary CLI/REPL entry uses Process-scoped PLAT001 hosting in `0.2.287-SNAPSHOT`, bundled-tool + exact/fresh/captured/workspace hosting is published in `0.2.291-SNAPSHOT`, and ordinary module + RootActor initial-module public-parse routing is published in `0.2.297-SNAPSHOT`. Final direct-production-entry retirement and the architecture guard remain. EXCLUSIVE retained; REUSE/SHARED deferred. |
