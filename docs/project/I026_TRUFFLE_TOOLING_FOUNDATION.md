...
| I026-A4B3 | IN_PROGRESS | — | I026-A4B2 | Production-driver cutover is partially published: ordinary CLI/REPL entry uses Process-scoped PLAT001 hosting in `0.2.287-SNAPSHOT`, and bundled-tool + exact/fresh/captured/workspace hosting is published in `0.2.291-SNAPSHOT`. Ordinary module + RootActor initial-module routing is next, followed by final direct-entry retirement. EXCLUSIVE retained; REUSE/SHARED deferred. |
