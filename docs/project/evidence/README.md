...
- [`PERF010-A/`](PERF010-A/) — retained PERF010-A causal-ablation, guarded-call, compiler-visibility, caller/helper-boundary, cross-runtime, and compiler-lifecycle diagnostic evidence; PERF010-A remains open.
