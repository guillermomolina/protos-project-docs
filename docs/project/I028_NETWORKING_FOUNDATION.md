...
- **D — TCP listener + `listenTcp` — IN_PROGRESS:** exact request snapshot/validation,
  ...
  - **D5 — integrated D conformance + closure — READY:** retain cross-slice listener/listen/accept/lifecycle/transfer/custody evidence and close I028-D without selecting the production backend.
