...
| LM008 | Core Language Surface Completeness | IN_PROGRESS | — | LM008-A/B/C/D are CLOSED. LM008-E is IN_PROGRESS with E1 control and E2 Error COMPLETE; E2 expands the central Error-taxonomy topology probe to all mandatory categories. E3 modules/import is next, E4 prelude/final E reconciliation follows, and LM008-F remains dependency-gated. Audits normative Core -> guest-visible path -> Protos conformance without inventing semantics. |
...
| LM008-E | IN_PROGRESS | E1 prior; E2 `SAME_COMMIT` | E1 control and E2 Error are COMPLETE. Standard Error signaling/handling, freshness/recorded identity and task-local handler behavior remain covered; the existing taxonomy fixture now proves all 21 mandatory direct-parent relations. E3 modules/import is next; no semantic/platform decision or production change. |
