...
| LM008 | Core Language Surface Completeness | IN_PROGRESS | — | LM008-A inventory/methodology and LM008-B grammar/evaluation/binding/callable audit are published; LM008-B is CLOSED. LM008-C is CLOSED after I031/#242 repaired its Object publication gaps. LM008-D is CLOSED after D1-D4 reconciliation: I032 and I034/#272, I035/#273, I036/#275 are closed, I031 supplies collection closed/frozen guest state, and every D row has retained Protos evidence. LM008-E is IN_PROGRESS with control checkpoint E1 COMPLETE; E2 Error is next, and LM008-F remains dependency-gated. Audits normative Core -> guest-visible path -> Protos conformance without inventing semantics. |
...
| LM008-E | IN_PROGRESS | E1 `SAME_COMMIT` | LM008-E control checkpoint E1 is COMPLETE: standard Closure `while` / `ensure` is fully covered by retained ordinary-Protos evidence; no new semantics or implementation owner. E2 Error audit is next. |
