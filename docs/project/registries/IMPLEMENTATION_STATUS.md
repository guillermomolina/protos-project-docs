...
| LM008 | Core Language Surface Completeness | IN_PROGRESS | — | LM008-A inventory/methodology and LM008-B grammar/evaluation/binding/callable audit are published; LM008-B is CLOSED. LM008-C is CLOSED after I031/#242 published the four previously missing standard Object guest surfaces with retained ordinary-Protos conformance and current-main reconciliation found all C rows covered. LM008-D remains BLOCKED_BY_DEPENDENCIES on its own collection implementation owners; its former I031 closed/frozen-state dependency is satisfied. LM008-E remains READY and LM008-F is dependency-gated. Audits normative Core -> guest-visible path -> Protos conformance without inventing semantics. |
