...
**I026-A4B2B3 — concurrent Core bootstrap closure** is now READY. It owns the static/root Core
publication audit and concurrent multi-Process bootstrap evidence. Only A4B2B3 may close
A4B2B/A4B2 and release A4B3.
