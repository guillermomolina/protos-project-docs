...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B1/E4B2/E4B3A published | Exact first-prerelease basis remains baseline `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`; E4B3B is READY. No real candidate SHA/tag/GitHub Release/assets yet. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B1/E4B2/E4B3A published | Selection remains `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`. E4B3B READY; no real candidate commit has been created and publication remains unauthorized. |
...
| DIST001-E4B | Detached candidate materialization | IN_PROGRESS | DIST001-E4B1/E4B2/E4B3A published | B1 worktree, B2 exact POM transition and B3A commit primitive are closed; B3B real candidate materialization is READY; B4 dependency-blocked. |
...
| DIST001-E4B3 | Detached candidate commit creation | IN_PROGRESS | DIST001-E4B3A published | Commit primitive is closed on isolated fixtures; E4B3B is READY to create and record the real detached candidate SHA. |
...
| DIST001-E4B3B | Real detached candidate materialization | READY | — | Compose E4B1+B2+B3A on the frozen selection, create the real `0.2.236` candidate commit, persist exact candidate SHA while keeping publication unauthorized; no branch/tag/GitHub Release/assets. |
