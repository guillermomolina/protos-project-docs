...
| I022 | Dynamic Error handlers / unwind-safe cleanup | IN_PROGRESS | — | I022-A/B/C/D CLOSED; I022-E IN_PROGRESS (E1/E2 CLOSED; E3 READY); D043 / spec `0.1.380`; general replay-stable handler/ensure/cancellation-unwind prerequisite for resource-owning LIB004 work |
...
| I022-E | IN_PROGRESS | — | — | Decomposed cancellation unwind: E1 internal lifecycle substrate CLOSED; E2 synchronous `ensure` cancellation outcome and later-transfer precedence CLOSED; E3 READY for suspending cleanup, same-request shielding closure, final Future terminalization and cleanup-created structured children. I022-E remains open until E3. |
...
| I022-E3 | READY | — | — | Permit cancellation cleanup to suspend without redelivery of the same request; keep task-backed Future pending during that cleanup; finalize CANCELLED only after successful cleanup/structured drain; preserve FAILED on cleanup Error and cover cleanup-created structured children. |
