...
| I028 | Core networking foundation | IN_PROGRESS | — | D047 / specification `0.1.388` and D048 / specification `0.1.391` RATIFIED. A1 IpAddress and A2 IpEndpoint local foundations are CLOSED; A3 ordinary Actor/P transfer conformance is READY and will close A. Later Network/TCP/backend/closure slices remain implementation work. `LIB005` stays blocked until I028 closes. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
| I028-A | Address/endpoint ordinary-object foundation | IN_PROGRESS | — | A1 IpAddress and A2 IpEndpoint local foundations are published; A3 Actor/P transfer/rematerialization conformance is READY and is the only remaining A slice. |
...
| I028-A3 | Actor/P transfer + A closure | READY | — | A1/A2 are closed; prove ordinary snapshot/rematerialization across Actor/P preserves canonical address/endpoint parent, exact slots, frozen state and equality/hash, then close I028-A. |
