...
| I026-A4 | Polyglot runtime-entry cutover | READY | — | I026-A2 + I026-A3; move CLI/REPL/top-level execution to the real language boundary and retire the old direct top-level compile/call architecture. |
