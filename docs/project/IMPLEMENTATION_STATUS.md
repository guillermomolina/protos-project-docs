...
| TOOL002 | Test Tool | IN_PROGRESS | `docs/project/TOOL002_TEST_TOOL.md` | TOOL002-A bundled-tool bootstrap CLOSED at `0.2.168-SNAPSHOT`; comparative and scale/distribution architecture checkpoints are selected/closed by `docs/design/TEST_TOOL_COMPARATIVE_AUDIT.md` and `docs/design/TEST_TOOL_SCALE_AND_DISTRIBUTION_ARCHITECTURE.md`; TOOL002-B local fresh-Process mechanism remains READY. |
...
| TOOL002-B | READY | Comparative + scale/distribution checkpoints CLOSED; establish/reuse the local general fresh-Process exact-execution mechanism with explicit capabilities/private streams and inert outcome. Keep TestPlan identity, physical worker placement, scheduler/resources, OS-worker/remote backends and reporting policy outside B. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| PERF001 | Core v0.1 baseline benchmark suite | IN_PROGRESS | — | PERF001-A/B/C/D CLOSED; PERF001-D reference timing evidence is `guillermomolina/protos-benchmarks@52b083cef5f8726f73be869c56f3cd2933e919ab`, generated by harness `0a406373c497df1173ff26a3ed4fcada015e0879` against exact pre/post-PERF002 revisions `8f363d0146164f99e72210eb44667f4efb7b88e7` / `3c93912a5579326374782a43527fbb51046f8f91`. PERF001-E is IN_PROGRESS with its audited six-workload Protos collections corpus phase; companion equivalence/timing evidence remains required. PERF001 remains open for broader sequential/concurrency coverage and final reproducibility/reporting. |
...
| PERF001-E | IN_PROGRESS | — | Fresh audit selected six deterministic sequential workloads: Array map/filter/reduce/stable-sort, Core Map lookup/update, and Map-backed Set algebra. Canonical Protos corpus publication/validation is the first phase; exact companion Python/JavaScript equivalence, correctness and timing evidence are still required before closure. |
