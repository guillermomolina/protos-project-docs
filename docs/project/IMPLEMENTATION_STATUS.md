...
| TOOL002 | Test Tool | IN_PROGRESS | `docs/project/TOOL002_TEST_TOOL.md` | A/B/C/D/E CLOSED; TOOL002-F IN_PROGRESS, F3A/F3B CLOSED, F3C/C1 READY, then F3D/E/F4 and G-J dependency-ordered. |
...
| TOOL002-F | IN_PROGRESS | F1/F2/F3A/F3B CLOSED; F3C/C1 minimal stored Test Tool mechanism READY; F3D/E/F4 dependency-gated. |
...
| TOOL002-F3 | IN_PROGRESS | F3A/F3B CLOSED; base and retained stored Error identity are independently established. F3C/C1 READY for bundled Test Tool stored-mode mechanism. |
...
| TOOL002-F3C | READY | F3B CLOSED; migrate retained Test Tool `stored:Error` only. |
| TOOL002-F3C1 | READY | F3B CLOSED; minimal positive bundled Test Tool stored mechanism only, without fresh mode/negatives/public activation. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B1 published | Exact first-prerelease basis remains baseline `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047`, `0.2.236-SNAPSHOT` -> `0.2.236`; E4B2 is READY. Candidate SHA/tag/GitHub Release/assets remain absent. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A/E4B1 published | Selected baseline `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`; E4B is subdivided, B2 READY, B3/B4 blocked. Candidate source revision remains UNMATERIALIZED and publication unauthorized. |
...
| DIST001-E4B | Detached candidate materialization | IN_PROGRESS | DIST001-E4B1 published | B1 detached-worktree guard is closed; B2 exact POM release-version transition is READY; B3/B4 dependency-blocked. |
...
| DIST001-E4B2 | Exact candidate POM version transition | READY | — | Use B1 to materialize candidate worktree and change only root `pom.xml` project version `0.2.236-SNAPSHOT` -> `0.2.236`; do not commit yet. |
| DIST001-E4B3 | Detached candidate commit creation | BLOCKED_BY_DEPENDENCIES | — | Depends on E4B2; commit only the validated release-version transition without creating a branch, tag or remote candidate ref. |
| DIST001-E4B4 | Release-only candidate lineage verification | BLOCKED_BY_DEPENDENCIES | — | Depends on E4B3; prove exact selected-baseline ancestry and release-only diff, then close E4B and make E4C1 ready. |
