...
| I023-B2D | IN_PROGRESS | — | I023-B2D1 published; D045/B008 normative resolution published | Body-Future/structured-ownership closure retains the closed Future-result boundary (B2D1); D045 resolves B008 task-scoped ownership and returns B2D2 to READY; B2D closes only after B2D2 publication. |
...
| I023-B2D2 | READY | — | D045 / spec `0.1.382`; B008 READY | Reconcile D044 with task-scoped structured ownership, run cross-B2 evidence, close I023-B2D/B2/B, and make I023-C READY. No per-callback activation drain, escape analysis, implicit detach, Future-result adoption, or loop-specific scheduler boundary is permitted. |
...
- B008 returned-Future structured-ownership boundary — READY via D045 / spec `0.1.382`; required implementation/conformance closure is I023-B2D2.
