...
| I028 | Core networking foundation | IN_PROGRESS | — | D047 / specification `0.1.388` and D048 / specification `0.1.391` RATIFIED. I028-A address/endpoint ordinary-object foundation is CLOSED after A1/A2 local factories plus A3 Actor/P transfer conformance; B-F Network/TCP/backend/final-closure work remains. `LIB005` stays blocked until I028 closes. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
