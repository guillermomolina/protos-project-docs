...
- B004 blocks only public/distributed Group acquisition/discovery because exact Group/GroupRef API/syntax and any new public discovery API remain normatively undefined; I011-19/I011-20 now cover the host-neutral remote ActorRef transport boundary and GroupRef routing over remote Actor members, including known-preaccept rerouting and acceptance uncertainty without transparent replay;
