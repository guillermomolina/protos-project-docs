...
| PERF003 | Collection algorithm Truffle compilability | READY | — | Discovered by PERF001-E evidence `guillermomolina/protos-benchmarks@4bff9f7f6c5e0e006530f166c188e0e988acf565` at Protos `86b35d8bb2d7ab2ad54bc2947e1bf7fbff1fca15`: `array-reduce` and `array-sort` execute correctly but each record 40 `GraphTooBig` failures. PERF003-A is READY for semantic-preserving Protos-side profiling/optimization; PERF003-B is dependency-gated external validation. |
...
| Slice | Status | Version | Closure evidence | Scope / unblock condition |
|---|---|---|---|---|
| PERF003-A | READY | — | — | Fresh current-main profiling and the narrowest semantic-preserving Protos-side optimization; targeted reduce/sort diagnostics must execute correctly without the recorded `GraphTooBig`, with focal/full/package/license validation. |
