...
| I026 | Truffle tooling foundation | IN_PROGRESS | — | AUD002 hybrid Truffle-first architecture. A1/A2/A3/A4A/A4B1 are published. PLAT001 is RATIFIED; A4B2 is IN_PROGRESS with A4B2A/B2B1/B2B2 CLOSED and A4B2B3 READY after D049 resolves B010. I026-D remains independently READY and A4B3 remains dependency-blocked. See docs/project/I026_TRUFFLE_TOOLING_FOUNDATION.md and docs/project/PLAT001_TRUFFLE_RUNTIME_HOSTING.md. |
...
| I026-A4B2B3 | Concurrent Core bootstrap closure | READY | — | D049 / specification `0.1.389` resolves B010: shared standard root/behavior is published frozen; implement A+ context-local executable projection plus concurrent Core publication/evidence before closing A4B2B/A4B2. A4B3 remains blocked until that implementation publishes. |
