...
| TOOL002-E | IN_PROGRESS | E1A/E1B/E2A/E2B CLOSED; E3 Java ownership cutover READY, followed by E4 final closure. |
...
| TOOL002-E3 | READY | Protos owns the complete retained TOML corpus execution/policy path; retire Java TOML manifest parsing, expectation interpretation and direct fixture execution, retaining only host-mechanical Java coverage. |
