...
| I022 | Dynamic Error handlers / unwind-safe cleanup | IN_PROGRESS | — | I022-A/B/C/D CLOSED; I022-E IN_PROGRESS (E1 CLOSED; E2 READY); D043 / spec `0.1.380`; general replay-stable handler/ensure/cancellation-unwind prerequisite for resource-owning LIB004 work |
...
| I022-E | IN_PROGRESS | — | — | Cost/risk decomposition after the I022-D replay work: E1 internal cancellation lifecycle substrate CLOSED; E2 READY for `ensure` cancellation outcome/precedence; E3 remains dependency-gated for suspending cleanup, same-request shielding, final Future terminalization and cleanup-created structured children. I022-E is not closed by E1 alone. |
...
| I022-E2 | READY | — | — | Integrate cancellation as an exact pending `ensure` outcome, run synchronous cancellation cleanup, and make cleanup Error/non-local return supersede the delivered cancellation without yet closing cleanup suspension/shielding. |
| I022-E3 | BLOCKED_BY_DEPENDENCIES | — | — | Permit cancellation cleanup to suspend without redelivery of the same request; keep task-backed Future pending during that cleanup; finalize CANCELLED only after successful cleanup/structured drain; preserve FAILED on cleanup Error and cover cleanup-created structured children. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| TOOL001 | Package Tool | IN_PROGRESS | `docs/project/TOOL001_PACKAGE_TOOL.md` | Bootstrap, confined Filesystem, metadata publication and canonical TOML C1-C4 are published; C5 is IN_PROGRESS with C5A manifest-scale parser prerequisite CLOSED and C5B root/package schema READY. |
| TOOL002 | Test Tool | IN_PROGRESS | `docs/project/TOOL002_TEST_TOOL.md` | A/B/C CLOSED; TOOL002-D IN_PROGRESS with D1/D2 CLOSED and subdivided D3 IN_PROGRESS; D3A1 complete-source loading CLOSED at `0.2.186-SNAPSHOT`, D3A2 simple single-case expectation policy READY. |
...
| TOOL001-C5 | package-tool manifest Slice 3C | IN_PROGRESS | TOOL001-C5A published | Cost-aware schema-v1 parent: C5A parser-scale prerequisite CLOSED; C5B root/manifest-version/package READY; C5C/C5D dependency-ordered. |
...
| TOOL001-C5B | package-tool manifest Slice 3C1 | READY | — | Root allowlist, exact manifest generation 1 and required package identity/version shape. |
| TOOL001-C5C | package-tool manifest Slice 3C2 | BLOCKED_BY_DEPENDENCIES | — | Compatibility, exports and workspace structural model after C5B. |
...
| TOOL001-C | legacy package-tool manifest Slice 3 parent | IN_PROGRESS | TOOL001-C1/C2/C3/C4/C5A published | C5B schema envelope/package is READY; C5C/C5D, C6 project metadata read/diagnostics and C7 final closure remain dependency-ordered. |
...
| TOOL002-D | IN_PROGRESS | D1/D2 CLOSED; D3 IN_PROGRESS through D3A1 at `0.2.186-SNAPSHOT`: bundled Runner can load one complete UTF-8 case source through the confined Filesystem/File boundary without executing it. D3A2 READY; D3A3/D3B/D3C dependent; D4 remains after D3 and `future-*` remains TOOL002-F. |
