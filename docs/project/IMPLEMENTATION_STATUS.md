...
| I022 | Dynamic Error handlers / unwind-safe cleanup | IN_PROGRESS | — | I022-A/B CLOSED; I022-C READY; D043 / spec `0.1.380`; general replay-stable handler/ensure/cancellation-unwind prerequisite for resource-owning LIB004 work |
...
| I022-C | READY | — | — | Publish D043 standard Closure `ensure(cleanup)` for synchronous normal/return/Error exits, exact result preservation, LIFO cleanup and later-transfer precedence. |
