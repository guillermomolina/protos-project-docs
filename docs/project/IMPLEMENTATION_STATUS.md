...
| TOOL001-F2D3C2 | detached plan -> separately-authorized application Process | IN_PROGRESS | — | C2A canonical initial-module execution and C2B detached-plan application Process wiring are CLOSED; C2C authority-isolation integration/closure is READY. |
...
| TOOL001-F2D3C2C | TOOL001 F2D3 application execution: C1->C2 authority-isolation integration + closure | READY | — | C1 and C2B are independently closed; prove that only detached plan data crosses from the Package Tool Process and close C2. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B1/E4B2/E4B3A/E4B3B1 published | Exact first-prerelease basis remains baseline `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`; E4B3B2 is READY. Candidate SHA remains UNMATERIALIZED; no tag/GitHub Release/assets. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B1 published | Selection is frozen and detached-worktree preparation tooling is closed; E4B2 is READY. E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B1/E4B2/E4B3A/E4B3B1 published | Selection remains `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`. E4B3B2 READY; candidate SHA remains UNMATERIALIZED and publication unauthorized. |
...
| DIST001-E4B | Detached candidate materialization | IN_PROGRESS | DIST001-E4B1/E4B2/E4B3A/E4B3B1 published | B1 worktree, B2 exact POM transition, B3A commit primitive and B3B1 composition/recovery guard are closed; B3B2 real candidate materialization is READY; B4 dependency-blocked. |
...
| DIST001-E4B3 | Detached candidate commit creation | IN_PROGRESS | DIST001-E4B3A/E4B3B1 published | Commit primitive and composition/recovery guard are closed; E4B3B2 is READY to create and persist the real detached candidate SHA. |
...
| DIST001-E4B3B | Real detached candidate materialization | IN_PROGRESS | DIST001-E4B3B1 published | B3B1 proves fresh composition and exact recovery/idempotency on fixtures; B3B2 is READY for the first real candidate creation + SHA persistence. |
...
| DIST001-E4B3B2 | Real candidate creation + SHA persistence | READY | — | Use B3B1 on frozen `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`, preserve the detached worktree as temporary reachability anchor, and persist the exact candidate SHA with publication still unauthorized. |
| DIST001-E4B4 | Release-only candidate lineage verification | BLOCKED_BY_DEPENDENCIES | — | Depends on E4B3; independently prove selected baseline -> candidate differs only by exact root project `0.2.236-SNAPSHOT` -> `0.2.236` transition, then close E4B. |
| DIST001-E4C | Candidate archive, envelope and audit preparation | BLOCKED_BY_DEPENDENCIES | — | Depends on E4B; build the exact release-mode archive, deterministic E3B envelope and candidate audit with truthful capabilities/limitations/blockers and `release_publication_authorized=false`. |
