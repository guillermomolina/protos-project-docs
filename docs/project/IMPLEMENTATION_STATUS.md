...
| TOOL002 | Test Tool | IN_PROGRESS | `docs/project/TOOL002_TEST_TOOL.md` | A/B/C/D/E CLOSED; TOOL002-F IN_PROGRESS, F3A CLOSED, F3B IN_PROGRESS with B1 CLOSED/B2 READY, then F3C/D/E/F4 and G-J dependency-ordered. |
...
| TOOL002-F | IN_PROGRESS | F1/F2 and F3A CLOSED; F3B IN_PROGRESS with F3B1 retained-fixture shape CLOSED and F3B2 READY; later F3/F4 work dependency-gated. |
...
| TOOL002-F3 | IN_PROGRESS | F3A CLOSED; F3B shape/observation decomposition active. B1 CLOSED, B2 READY, B3 blocked; C/D/E remain dependency-gated. |
...
| TOOL002-F3B | IN_PROGRESS | Exact retained stored fixture shape is proven by B1 without observation; B2 one post-terminal observation is READY. |
...
| TOOL002-F3B2 | READY | F3B1 CLOSED; terminalize retained Future without observation, invoke `observe` once, and require exact identity with local `error`. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A published | Exact first-prerelease basis is selected: baseline `0`, `1` -> `2`; E4B is READY. No candidate SHA/tag/GitHub Release/assets yet. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A published | Exact baseline/version selection is frozen; E4B is READY for detached candidate materialization. E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A published | Selected baseline `0` / `1` -> `2`; E4B READY, E4C/E4D dependency-blocked. Candidate source revision remains UNMATERIALIZED and publication unauthorized. |
...
| DIST001-E4B | Detached candidate materialization | READY | — | Derive a local candidate from exact selected baseline with only the exact project POM `0.2.236-SNAPSHOT` -> `0.2.236` transition; no main merge, tag, remote branch, release, or assets. |
