...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2 published | DIST001-E3 is READY. Baseline/candidate/version remain unselected; no tag, GitHub Release, or release asset is authorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2 published | E2 fixes the generic `V-SNAPSHOT -> V`, tag `vV`, GitHub prerelease contract and isolated candidate-commit model; E3 is READY. Candidate-specific E4 still requires explicit user selection. |
...
| DIST001-E3 | Release metadata, assets and validation preparation | READY | — | Implement generic release-mode SOURCE metadata/provenance, notes, checksums/asset manifest, exact version-transition guards and candidate validation entry point. No tag or GitHub Release. |
...
DIST001-A/B/C/D and DIST001-E1/E2 are closed. The B5 gate remains the reusable
...
DIST001-E is IN_PROGRESS through the bounded E1-E6 plan; E3 is READY. E2 fixes
only the generic public-version/candidate-commit contract: no concrete baseline,
candidate, version, tag, GitHub Release, or release asset is selected or
authorized.
