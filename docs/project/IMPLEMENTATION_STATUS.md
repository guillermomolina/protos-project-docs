...
| TOOL001-F2E1 | `protos-package-tree-v1` ContentIdentity canonical tree contract | IN_PROGRESS | TOOL001-F2E1A `SAME_COMMIT` | Subdivided into E1A logical tree/path domain, E1B canonical byte stream + method/hash, and E1C independent conformance/closure. E1A CLOSED; E1B READY. |
...
| TOOL001-F2E1B | canonical byte stream + method/hash contract | READY | — | Depends on E1A. Define exact serialization over E1A's finite path->bytes map, ordering, length/domain separation, `protos-package-tree-v1`, initial SHA-256 behavior and digest-agility relation. |
| TOOL001-F2E1C | independent conformance vectors + F2E1 closure | BLOCKED_BY_DEPENDENCIES | — | Depends on E1B. Publish positive/negative canonical vectors, exact expected digests, mutation/collision/symlink rejection evidence and close ContentIdentity before E2 store binding. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C1/E4C2/E4C3 published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` / archive `protos-0.2.236-posix-jvm.zip` has independently verified identity and a frozen truthful claims set. E4C4 deterministic envelope generation is READY; no tag/GitHub Release/assets and publication remains unauthorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C1/E4C2/E4C3 published | Candidate/archive identity plus explicit capabilities/limitations are fixed. E4C4 READY; E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B + DIST001-E4C1/E4C2/E4C3 published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` / `protos-0.2.236-posix-jvm.zip` now has independently verified identity and frozen release-note claims with blocker review PASS. E4C4 READY; publication remains unauthorized. |
...
| DIST001-E4C | Candidate archive/envelope/audit preparation | IN_PROGRESS | DIST001-E4C1/E4C2/E4C3 published | Exact archive identity and ordered capability/limitation claims are fixed; E4C4 deterministic release-envelope generation is READY. |
...
| DIST001-E4C4 | Deterministic release-envelope generation | READY | — | Consume `DIST001_E4_RELEASE_CLAIMS.txt` unchanged with E3B metadata generation for exact `protos-0.2.236-posix-jvm.zip` / `b1a58ba445d082156bd4eb637ee6df70c046abdee600d468c0fac29be065e296`; produce notes/manifest/checksum without candidate-audit or publication. |
