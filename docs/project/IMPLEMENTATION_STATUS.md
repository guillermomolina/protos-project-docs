...
| I022 | Dynamic Error handlers / unwind-safe cleanup | IN_PROGRESS | — | I022-A/B/C/D CLOSED; I022-E READY; D043 / spec `0.1.380`; general replay-stable handler/ensure/cancellation-unwind prerequisite for resource-owning LIB004 work |
...
| I022-E | READY | — | — | Cooperative cancellation unwind: distinguish request/observation/unwind/terminal cancellation, shield only the already-delivered request during cleanup, permit suspending cleanup, and map cleanup failure to failed rather than cancelled Future. |
