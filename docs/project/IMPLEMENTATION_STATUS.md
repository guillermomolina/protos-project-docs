...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2 + DIST001-E3A/E3B published | DIST001-E3C is READY. Baseline/candidate/version remain unselected; no tag, GitHub Release, or release asset is authorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2 + DIST001-E3A/E3B published | E3A/E3B are closed; E3C is READY for generic candidate-validation composition. Candidate-specific E4 still requires E3 closure plus explicit user selection. |
...
| DIST001-E3 | Release metadata, assets and validation preparation | IN_PROGRESS | DIST001-E3A/E3B published | E3A builder/provenance and E3B deterministic notes/assets/checksum envelope are closed; E3C is READY. No candidate/tag/Release selected. |
...
| DIST001-E3C | Candidate validation entry point and E3 closure | READY | — | Compose release-mode archive/source identity, complete extracted validation, E3B notes/assets/checksum envelope and release-claim/publication guards; close E3 and make E4 READY for explicit candidate selection. |
...
DIST001-A/B/C/D and DIST001-E1/E2 are closed. DIST001-E3 is IN_PROGRESS through
bounded E3A-E3C slices: E3A/E3B are closed and E3C is READY. The B5 gate remains
the reusable extracted-distribution conformance entry point and E3B now provides
the deterministic release notes/assets/checksum envelope. No concrete release
baseline, candidate, public version, tag, GitHub Release, or release asset is
