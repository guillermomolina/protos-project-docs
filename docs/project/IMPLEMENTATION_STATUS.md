...
- public/distributed Group acquisition and language-visible GroupRef send/request selector installation plus genuinely remote routing/transport uncertainty; local Group operation backpressure, READY wakeup, pre-acceptance rerouting, concrete acceptance authority, cancellation, retry, and request accepted-loss uncertainty are wired;
