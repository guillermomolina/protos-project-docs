...
| I028 | Core networking foundation | READY | — | D047 / specification `0.1.388` and D048 / specification `0.1.391` RATIFIED. D048 closes the address/endpoint construction-recognition entry gate: canonical frozen ordinary factory/prototypes, ordinary invocation, exact transparent recognition and `recognizes(value)` are selected. I028-A is READY; later Network/TCP/backend/closure slices remain implementation work. `LIB005` stays blocked until I028 closes. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
