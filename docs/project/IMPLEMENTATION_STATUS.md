...
| TOOL002-F | IN_PROGRESS | F1/F2/F3A/F3B/F3C/F3D CLOSED; F3E IN_PROGRESS with E1 parser CLOSED and E2 fresh evaluator READY; F4 remains dependency-gated. |
...
| TOOL002-F3 | IN_PROGRESS | F3A/F3B/F3C/F3D CLOSED; F3E IN_PROGRESS with E1 MODE:ErrorPrototype parsing CLOSED and E2 READY. |
...
| TOOL002-F3E | IN_PROGRESS | E1 MODE:ErrorPrototype parser CLOSED; E2 fresh evaluator READY; E3A/E3B/E4 remain dependency-ordered; public Future activation remains F4. |
...
| TOOL002-F3E2 | READY | TOOL002-F3E1; add only positive private `fresh` observation evaluation over the retained cancellation evidence. |
| TOOL002-F3E3A | BLOCKED_BY_DEPENDENCIES | TOOL002-F3E2; compose one private stored/fresh observation evaluator without public selection. |
| TOOL002-F3E3B | BLOCKED_BY_DEPENDENCIES | TOOL002-F3E3A; add integrated malformed/mismatch negative policy. |
| TOOL002-F3E4 | BLOCKED_BY_DEPENDENCIES | TOOL002-F3E3B; governance reconciliation only, close F3E/F3 and make F4 READY. |
...
| DIST002 | Development/release toolchain alignment | IN_PROGRESS | DIST002-A `b66e94ca31bd83147f2c0e39a268d5de9323bf14`; DIST002-B `SAME_COMMIT` | Deferred follow-up, intentionally not a dependency of the frozen DIST001 0.2.236 candidate. Centralize Java bytecode/GraalVM/JDK/Truffle/Maven coordinates; align devcontainer + ordinary CI + release validation; pre-provision the primary runtime so normal gates do not download JDKs on demand; make future runtime migrations explicit. See `docs/project/DIST002_TOOLCHAIN_ALIGNMENT.md`. DIST002-A CLOSED after explicit owner selection: root `toolchain.json` is the canonical Java21/GraalVM25.3.4.1-JDK25.0.4.1/Truffle25.3.4.1/Maven3.9.9 contract; DIST002-B READY. See `docs/project/DIST002_TOOLCHAIN_ALIGNMENT.md`. DIST002-B CLOSED on the canonical JDK25/Maven3.9.9 development/ordinary-CI environment; DIST002-C READY. |
...
| DIST002-C | Align distribution/runtime metadata + validation | READY | — | DIST002-B is CLOSED. Migrate live `pom.xml` Graal/Truffle and DIST001-derived distribution/runtime validation bindings to the canonical contract while preserving historical release evidence and removing ordinary on-demand-JDK gate dependence. |
