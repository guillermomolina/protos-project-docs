...
| I026 | Truffle tooling foundation | READY | — | Approved AUD002 runtime/compiler foundation: registered TruffleLanguage + Source ownership, source sections, instrumentation/tags, semantically faithful value/scope bridges, then real Graal DAP and dynamic-LSP smoke gates. See docs/project/I026_TRUFFLE_TOOLING_FOUNDATION.md. |
