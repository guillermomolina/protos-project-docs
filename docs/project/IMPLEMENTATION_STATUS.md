...
| I023 | Standard `while` protocol | IN_PROGRESS | I023-A + I023-B + I023-C1 + I023-C2 + I023-C3 published | D044 / spec `0.1.381` + D045 / spec `0.1.382`; B + C1/C2/C3 closed, I023-C4 READY |
...
| I023-C | IN_PROGRESS | — | I023-C1 + I023-C2 + I023-C3 published | Condition replay, body replay, and cooperative cancellation/ensure composition are closed. C4 repeated cross-phase suspension plus bounded-state adversarial closure is READY. |
...
| I023-C4 | READY | — | — | C1/C2/C3 are closed. Compose repeated condition/body suspension with bounded replay-state evidence and final adversarial C closure; then make I023-D READY. |
