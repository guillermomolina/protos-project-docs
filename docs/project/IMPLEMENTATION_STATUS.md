...
| I026-A4 | Polyglot runtime-entry cutover | IN_PROGRESS | — | I026-A2 + I026-A3; refined into A4A/A4B. A4A supplies the entered Polyglot execution substrate; A4 closes only after A4B migrates all primary runtime drivers and retires the direct compiler/call entry architecture. |
...
| I026-A4B | Primary runtime-driver cutover | READY | — | I026-A4A; migrate CLI/REPL/bundled tools/workspace and remaining production top-level execution to the entered language context, then remove the direct compile/call path as a separate primary runtime architecture. |
...
| LIB004 | Filesystem / process conveniences | IN_PROGRESS | — | LIB004-0 design CLOSED; LIB004-A implementation remains IN_PROGRESS through subdivided A1/A2/A3, with A1/A2 published in ordinary `std:io/Files` conformance and A3 READY; LIB004-D remains independently READY. |
...
| LIB004-A3 | READY | — | — | After A2, adversarial cancellation during pending open and late successful acquisition, final owned-open custody audit, native boundary/status reconciliation, and closure of parent LIB004-A. |
