...
| I023 | Standard `while` protocol | IN_PROGRESS | I023-A + I023-B + I023-C1 + I023-C2 published | D044 / spec `0.1.381` + D045 / spec `0.1.382`; B + C1 + C2 closed, I023-C3 READY |
...
| I023-C | IN_PROGRESS | — | I023-C1 + I023-C2 published | Condition and body suspension/replay are closed with repeated real Future.value() suspension and exact-once effects. C3 cooperative cancellation/ensure is READY; C4 final repeated cross-phase/bounded-state closure remains dependency-gated. |
...
| I023-C3 | READY | — | — | C1/C2 are closed. Exercise cooperative cancellation through while plus ensure, proving no loop-added cancellation observation boundary and no duplicated unwind/cleanup. |
