...
| I026 | Truffle tooling foundation | IN_PROGRESS | — | AUD002 hybrid Truffle-first architecture. A1/A2/A3/A4A/A4B1 are published. PLAT001 is RATIFIED; A4B2 is IN_PROGRESS with A4B2A/B2B1/B2B2 CLOSED and A4B2B3 BLOCKED by B010. I026-D remains independently READY and A4B3 remains dependency-blocked. See docs/project/I026_TRUFFLE_TOOLING_FOUNDATION.md and docs/project/PLAT001_TRUFFLE_RUNTIME_HOSTING.md. |
...
| I026-A4B2B3 | Concurrent Core bootstrap closure | BLOCKED | — | A+ executable-layer ownership approved; B010 blocks concurrent Core-root publication until standard `Object` structural-state/isolation semantics are normatively closed. A4B3 remains blocked. |
...
| I028 | Core networking foundation | OPEN | — | D047 / specification `0.1.388` RATIFIED. Exact public `IpAddress`/`IpEndpoint` construction/recognition selector surface remains an explicit bounded design checkpoint before implementation publication; then implement explicit Network authority, TCP connection/listener acquisition, concurrent accept, existing Byte-I/O/lifecycle composition, Actor/P non-transferability and portable backend closure. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
