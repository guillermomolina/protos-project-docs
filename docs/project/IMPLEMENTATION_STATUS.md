...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B1/E4B2/E4B3 published | First public-prerelease candidate `957b1e16793a682de1d6406e37b5734c44d32d19` is materialized from `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`. E4B4 is READY for independent lineage verification; no tag/GitHub Release/assets and publication remains unauthorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B1/E4B2/E4B3 published | Exact candidate `957b1e16793a682de1d6406e37b5734c44d32d19` / `0.2.236` is selected and locally reachable through its detached worktree. E4B4 is READY; E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B1/E4B2/E4B3 published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` is materialized from `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` with only `0.2.236-SNAPSHOT` -> `0.2.236` intended. E4B4 READY for independent lineage verification; publication unauthorized. |
...
| DIST001-E4B | Detached candidate materialization | IN_PROGRESS | DIST001-E4B1/E4B2/E4B3 published | Real candidate `957b1e16793a682de1d6406e37b5734c44d32d19` is materialized and its SHA persisted; E4B4 is READY to independently verify release-only lineage and close E4B. |
...
| DIST001-E4B4 | Release-only candidate lineage verification | READY | — | Independently prove `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` -> `957b1e16793a682de1d6406e37b5734c44d32d19` changes only root project `0.2.236-SNAPSHOT` -> `0.2.236`, confirm candidate local detached reachability and release-publication guards, then close E4B. |
