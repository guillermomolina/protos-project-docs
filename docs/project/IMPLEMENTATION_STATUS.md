...
| TOOL002 | Test Tool | IN_PROGRESS | `docs/project/TOOL002_TEST_TOOL.md` | A/B/C/D/E CLOSED; TOOL002-F IN_PROGRESS, F3A CLOSED after A1/A2/A3, F3B/F3B1 READY, then F3C/D/E/F4 and G-J dependency-ordered. |
...
| TOOL001-F2D3B | exact workspace package-backed module resolver | IN_PROGRESS | TOOL001-F2D3B1/F2D3B2A published | Package identity/source mechanism + self: routing CLOSED; dep: edge/export routing READY. |
...
| TOOL001-F2D3B2 | resolver routing | IN_PROGRESS | TOOL001-F2D3B2A published | Importer-relative self: routing CLOSED; dep: edge/export routing READY, std:/closure remains dependency-gated. |
...
| TOOL001-F2D3B2B | dep: edge/export routing | READY | — | Follow exactly one detached declaring-package alias edge, then target export -> internal logical module without bypass. |
...
| TOOL002-F | IN_PROGRESS | F1/F2 CLOSED; F3 IN_PROGRESS under the finer A/B/C/D/E decomposition. F3A semantic prerequisites/governance are CLOSED; F3B/F3B1 retained fixture-shape validation is READY; F4 remains dependency-gated. |
...
| TOOL002-F3 | IN_PROGRESS | F3A-E isolate same-domain stored semantics, retained fixture shape, Test Tool stored policy, fresh cancellation identity and final integration. F3A CLOSED; F3B READY. |
...
| TOOL002-F3B | READY | F3A CLOSED; validate retained stored observation fixture shape outside Test Tool policy. |
| TOOL002-F3B1 | READY | Validate exact local `future` / `error` / zero-argument `observe` slots only. |
| TOOL002-F3B2 | BLOCKED_BY_DEPENDENCIES | TOOL002-F3B1; one post-terminal observe invocation must signal the exact retained local Error. |
| TOOL002-F3B3 | BLOCKED_BY_DEPENDENCIES | TOOL002-F3B2; second post-terminal observation must satisfy `first === second === error`, closing F3B. |
| TOOL002-F3C | BLOCKED_BY_DEPENDENCIES | TOOL002-F3B; migrate Test Tool `stored:Error` only. |
| TOOL002-F3C1 | BLOCKED_BY_DEPENDENCIES | TOOL002-F3B3; minimal positive stored Test Tool mechanism only. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 published | DIST001-E4 is READY for an explicit exact baseline/public-version selection decision. No candidate, tag, GitHub Release, or release asset is currently selected/authorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 published | Generic release preparation is closed. E4 is READY for explicit candidate selection/validation; E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | READY | — | E2/E3 dependencies are closed. Execution remains gated on an explicit user decision selecting the exact development baseline/public version; E4 validates/freezes only and records release_publication_authorized=false. |
