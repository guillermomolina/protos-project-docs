...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DOC001 | Protos Programming Documentation | IN_PROGRESS | `docs/project/DOC001_PROGRAMMING_DOCUMENTATION.md` | A/B/C/D/E/F/G/H CLOSED; I023/B007 CLOSED; I-L READY independently; M toolchain-gated; N final closure. |
...
| TOOL001-F2E2 | verified read-only package-store binding | BLOCKED_BY_DEPENDENCIES | I024 | D046 resolves B009 normatively, but verified store binding waits for general Filesystem.entries/captureTree implementation and conformance; no package-specific Java tree walker. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C + DIST001-E4D1/E4D2/E4D3 published | Frozen candidate `957b1e16793a682de1d6406e37b5734c44d32d19` now passes immutable consistency, release-aware B5 and independent 4-capability/5-limitation + B001-B008 + spec `0.1.382` audit. E4D4 tag/Release collision + publication guard is READY; publication remains unauthorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C + DIST001-E4D1/E4D2/E4D3 published | D1 consistency, D2 release-aware B5 and D3 claims/blockers/spec audit are CLOSED. E4D4 publication collision/guard is READY; E5 remains separately authorized. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B + DIST001-E4C + DIST001-E4D1/E4D2/E4D3 published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` / `protos-0.2.236-posix-jvm.zip` passes D1-D3, including exact claims SHA `ad0b77ae5bd41bc16e306487072620c99581643d68ed5141011e7537c0439e33`, B001-B008 CLOSED and spec revision `0.1.382`. E4D4 READY; publication unauthorized. |
...
| DIST001-E4D | Immutable full candidate validation and E4 closure | IN_PROGRESS | DIST001-E4D1/E4D2/E4D3 published | D1 consistency, D2 release-aware B5 and D3 claims/blockers/spec audit CLOSED; D4 tag/Release collision + publication guard READY. |
...
| DIST001-E4D4 | Tag/Release collision + publication guard | READY | — | Check exact future tag `v0.2.236`, GitHub Release collision/absence and all persisted publication=false guards without creating a tag, Release or asset; do not duplicate D3 or D5 validation. |
