...
| I022 | Dynamic Error handlers / unwind-safe cleanup | IN_PROGRESS | — | I022-A/B/C CLOSED; I022-D READY; D043 / spec `0.1.380`; general replay-stable handler/ensure/cancellation-unwind prerequisite for resource-owning LIB004 work |
...
| I022-D | READY | — | — | Suspension/replay conformance: protected body and cleanup survive `Future.value()` suspension without duplicated frame installation, body execution, handler state, or cleanup effects. |
