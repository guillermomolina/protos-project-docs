...
| TOOL002 | Test Tool | IN_PROGRESS | `docs/project/TOOL002_TEST_TOOL.md` | A/B/C/D/E CLOSED; TOOL002-F IN_PROGRESS, F3A/F3B CLOSED, F3C/C1 IN_PROGRESS with C1A CLOSED/C1B READY, then C2/F3D/E/F4 and G-J dependency-ordered. |
...
| TOOL001-F | canonical physical lockfile v1 | IN_PROGRESS | TOOL001-F1/F2A/F2B/F2C/F2D1/F2D2 published | Workspace execution-plan policy + pure plan construction CLOSED; F2D3 mechanical host handoff READY. |
...
| TOOL001-F2 | physical lock integration | IN_PROGRESS | TOOL001-F2A/F2B/F2C/F2D1/F2D2 published | Physical validation + workspace plan construction CLOSED; F2D3 host resolver/preflight READY. |
...
| TOOL001-F2D3C | command-scoped workspace preflight + authority separation | IN_PROGRESS | — | C1 and C2 are CLOSED; only C3 public workspace-run wiring/final closure remains. |
...
| TOOL001-F2D3C3 | public workspace-run wiring + F2D3/F2D closure | IN_PROGRESS | — | Subdivided into C3A CLI-neutral driver composition and C3B public `protos run` policy/wiring plus final F2D3/F2D closure. |
| TOOL001-F2D3C3A | TOOL001 F2D3 public-run integration: CLI-neutral workspace-run driver | CLOSED | `SAME_COMMIT` | Compose closed C1 preflight and closed C2 application execution behind an explicit projectRoot + logical-entry + application-authority request; no CLI spelling/current-directory/default-entry policy. |
| TOOL001-F2D3C3B | TOOL001 F2D3 public-run integration: public `protos run` wiring + final F2D3/F2D closure | READY | — | C3A closes mechanical driver composition; decide and wire only the public command/project-root/entry convention and final diagnostics/closure. |
...
| TOOL002-F | IN_PROGRESS | F1/F2/F3A/F3B CLOSED; F3C/C1 IN_PROGRESS. C1A generic live-result inspection host boundary CLOSED, C1B positive stored Protos policy READY. |
...
| TOOL002-F3 | IN_PROGRESS | F3A/F3B CLOSED; F3C active. C1A host live-result boundary CLOSED and C1B positive retained stored policy READY; fresh/negative/final integration remains dependency-gated. |
...
| TOOL002-F3C | IN_PROGRESS | F3B CLOSED; C1 decomposed into C1A generic host live-result inspection CLOSED and C1B positive Protos stored policy READY. |
| TOOL002-F3C1 | IN_PROGRESS | C1A `0.2.241-SNAPSHOT` / `SAME_COMMIT` CLOSED; C1B positive retained `stored:Error` bundled-Protos policy READY. |
...
| TOOL002-F3C1B | READY | F3C1A CLOSED; positive retained `stored:Error` policy in bundled Protos only; no fresh/negative/public activation. |
| TOOL002-F3C2 | BLOCKED_BY_DEPENDENCIES | TOOL002-F3C1; stored-mode negative/malformed/parent evidence only; close F3C. |
...
| PERF003 | Collection algorithm Truffle compilability | IN_PROGRESS | — | PERF003-A `0.2.170-SNAPSHOT` cut valid external `array-reduce` `GraphTooBig` failures from 40 to 2. The `0.2.175-SNAPSHOT` correction reduced graph size to 150069 / 150000 and `0.2.178-SNAPSHOT` reduced it again to 150036 while preserving exact result 528. A third ordinary-Protos reduce initialization-state refinement is published by this phase at `0.2.180-SNAPSHOT`; an exact external rerun remains required before A can close. PERF003-B remains dependency-gated. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C1 published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` produced `protos-0.2.236-posix-jvm.zip` SHA-256 `b1a58ba445d082156bd4eb637ee6df70c046abdee600d468c0fac29be065e296`. E4C2 is READY for independent archive/SOURCE/RUNTIME verification; no tag/GitHub Release/assets and publication remains unauthorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C1 published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` and first public-prerelease archive `protos-0.2.236-posix-jvm.zip` / `b1a58ba445d082156bd4eb637ee6df70c046abdee600d468c0fac29be065e296` are fixed. E4C2 READY; E5 remains dependency-blocked and separately authorized. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B + DIST001-E4C1 published | E4C1 built `protos-0.2.236-posix-jvm.zip` from `957b1e16793a682de1d6406e37b5734c44d32d19` and persisted SHA-256 `b1a58ba445d082156bd4eb637ee6df70c046abdee600d468c0fac29be065e296`. E4C2 READY; publication remains unauthorized. |
...
| DIST001-E4C | Candidate archive/envelope/audit preparation | IN_PROGRESS | DIST001-E4C1 published | Exact archive `protos-0.2.236-posix-jvm.zip` / `b1a58ba445d082156bd4eb637ee6df70c046abdee600d468c0fac29be065e296` built from candidate `957b1e16793a682de1d6406e37b5734c44d32d19`; E4C2 independent archive/SOURCE/RUNTIME verification is READY. |
...
| DIST001-E4C2 | Archive identity + SOURCE/RUNTIME verification | READY | — | Independently verify persisted `protos-0.2.236-posix-jvm.zip` / `b1a58ba445d082156bd4eb637ee6df70c046abdee600d468c0fac29be065e296` against candidate `957b1e16793a682de1d6406e37b5734c44d32d19`, release baseline `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047`, public version `0.2.236`, SOURCE and RUNTIME invariants. |
| DIST001-E4C3 | Release-note claims selection | BLOCKED_BY_DEPENDENCIES | — | Depends on E4C2; select truthful capabilities/limitations only. |
| DIST001-E4C4 | Deterministic release-envelope generation | BLOCKED_BY_DEPENDENCIES | — | Depends on E4C3; generate E3B release notes/manifest/checksum envelope. |
| DIST001-E4C5 | Candidate-audit materialization | BLOCKED_BY_DEPENDENCIES | — | Depends on E4C4; materialize explicit candidate audit with publication authorization still false. |
| DIST001-E4D | Immutable full candidate validation and E4 closure | BLOCKED_BY_DEPENDENCIES | — | Depends on E4C; run composed candidate gate/full required validation, freeze exact candidate/artifact identity for E5, and keep publication authorization separate. |
