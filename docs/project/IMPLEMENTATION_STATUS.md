...
- B004 blocks public/distributed Group acquisition/discovery because exact Group/GroupRef API/syntax and any new public discovery API remain normatively undefined; genuinely remote routing/transport acceptance uncertainty remains independent implementation work, while language-visible GroupRef send/request and the complete local/cross-Process Group routing semantics are now conformance-covered;
