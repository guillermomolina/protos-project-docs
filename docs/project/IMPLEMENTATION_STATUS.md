...
|---|---|---|---|---|
| PLAT001 | Truffle runtime hosting topology | RATIFIED | Explicit project-owner approval on 2026-09-08 after comparison with Espresso, TruffleRuby, Sulong, GraalWasm, GraalPy and JavaScript-style isolation plus scalability/future review. | I026-A4; current hosting is shareable Engine + one multithread Context per hosted Process, while Engine/Context/Thread remain non-semantic implementation placement. `ContextPolicy.SHARED`, pooling/preinit and exact Engine topology remain deferred. See docs/project/PLAT001_TRUFFLE_RUNTIME_HOSTING.md. |
...
| I026 | Truffle tooling foundation | IN_PROGRESS | — | AUD002 hybrid Truffle-first architecture. A1/A2/A3/A4A/A4B1 are published. PLAT001 is RATIFIED; A4B2 is IN_PROGRESS through A4B2A-A4B2B with A4B2A CLOSED and A4B2B READY, while D remains independently READY and A4B3 remains dependency-blocked. See docs/project/I026_TRUFFLE_TOOLING_FOUNDATION.md, docs/project/I026_A4B1_TRUFFLE_MULTITHREAD_SAFETY.md, docs/project/I026_A4B2A_PROCESS_CONTEXT_HOSTING.md and docs/project/PLAT001_TRUFFLE_RUNTIME_HOSTING.md. |
...
| I026-A4B | Primary runtime-driver cutover | IN_PROGRESS | — | PLAT001 ratified; A4B1 multithread safety is published, A4B2 is READY for Process-scoped hosting, and A4B closes only after A4B3 completes production-driver cutover/legacy-entry retirement. |
...
| I026-A4B2B | Actor/P Context routing + concurrent Core bootstrap | READY | — | I026-A4B2A; route Actor/P carriers through the owning Process Context and close bounded concurrent Core-root bootstrap publication before A4B2/A4B3 transition. |
...
| LIB004 | Filesystem / process conveniences | IN_PROGRESS | — | LIB004-0/A/B CLOSED; LIB004-C READY; LIB004-D READY; LIB004-E remains dependency-gated. |
...
| LIB004-C | READY | — | — | LIB004-A/B CLOSED; add explicit-Encoding `readAllText`/`writeAllText`, one-shot codec composition, no default Encoding, and complete text/cleanup conformance. |
