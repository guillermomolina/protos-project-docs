...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` independently verified from `3c23eaaccecbdcc7c2bcd86bc30c445403cfb047` / `0.2.236-SNAPSHOT` -> `0.2.236`. E4C1 is READY; no tag/GitHub Release/assets and publication remains unauthorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B published | Candidate `957b1e16793a682de1d6406e37b5734c44d32d19` is materialized and independently lineage-verified. E4C1 READY; E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B published | E4B closed on independently verified candidate `957b1e16793a682de1d6406e37b5734c44d32d19`. E4C1 READY for public-prerelease ZIP build; publication unauthorized. |
...
| DIST001-E4C | Candidate archive/envelope/audit preparation | IN_PROGRESS | — | E4B CLOSED. E4C is decomposed into C1-C5; E4C1 public-prerelease portable ZIP build is READY. |
| DIST001-E4C1 | Public-prerelease portable ZIP build | READY | — | Build the exact release-mode portable ZIP from the persisted candidate; no envelope/claims/audit yet. |
| DIST001-E4C2 | Archive identity + SOURCE/RUNTIME verification | BLOCKED_BY_DEPENDENCIES | — | Depends on E4C1; verify archive identity/provenance/runtime surfaces before claims. |
