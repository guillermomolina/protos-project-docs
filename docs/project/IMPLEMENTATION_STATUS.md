...
| I028 | Core networking foundation | IN_PROGRESS | — | D047 / specification `0.1.388` and D048 / specification `0.1.391` RATIFIED; PLAT002 represented Network-capability architecture RATIFIED. I028-A is CLOSED. I028-B is IN_PROGRESS with B1 canonical Network prototype CLOSED and B2 READY; C-F remain dependency-gated. `LIB005` stays blocked until I028 closes. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
...
| I028-B | Network capability + bootstrap provisioning | IN_PROGRESS | — | PLAT002 RATIFIED. B1 canonical source-backed Network prototype is CLOSED; B2 represented capability is READY; B3-B5 remain dependency-gated. No TCP/backend selection yet. |
...
| I028-B2 | Represented Network capability + transfer confinement | READY | — | Implement the ratified PLAT002 represented wrapper and explicit Actor/P non-transferability without bootstrap endowment or TCP operations. |
| I028-B3 | Optional RootActor network bootstrap endowment | BLOCKED_BY_DEPENDENCIES | I028-B2 | Provision only an explicit host-granted initial-module local `network`; absent when ungranted, never Prelude/import/new-Actor ambient authority. |
