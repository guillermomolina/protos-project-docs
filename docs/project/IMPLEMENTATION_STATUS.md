...
| I026 | Truffle tooling foundation | IN_PROGRESS | — | AUD002 hybrid Truffle-first architecture. A1/A2/A3/A4A are published. PLAT001 is RATIFIED; A4B is IN_PROGRESS through A4B1-A4B3 with A4B1 READY, while D remains independently READY. See docs/project/I026_TRUFFLE_TOOLING_FOUNDATION.md and docs/project/PLAT001_TRUFFLE_RUNTIME_HOSTING.md. |
...
| I026-A4B | Primary runtime-driver cutover | IN_PROGRESS | — | PLAT001 ratified; execute ordered A4B1-A4B3 and close only after multithread safety, Process-scoped hosting and complete production-driver cutover are published. |
| I026-A4B1 | Truffle multithread safety + carrier entry | READY | — | I026-A4A + PLAT001; audit shared implementation state, authorize only validated concurrent Truffle access, replace owner-thread confinement with bounded enter/leave, and prove no global execution lock/GIL or semantic ThreadLocal. |
| I026-A4B2 | Shared Engine + Process-scoped Context hosting | BLOCKED_BY_DEPENDENCIES | — | I026-A4B1; implement PLAT001 hosting/lifecycle and prove independent multi-Process plus concurrent-Actor behavior. |
...
| LIB004 | Filesystem / process conveniences | IN_PROGRESS | — | LIB004-0 design CLOSED; LIB004-A is CLOSED through A1/A2/A3; LIB004-B is READY; LIB004-D is READY; C/E remain dependency-gated. |
...
| LIB004-B | READY | — | — | LIB004-A CLOSED; add `writeAllBytes` with invocation-time private Bytes snapshot, fixed writable create-or-truncate positioned policy, bounded sequential writes, committed-prefix/failure/cancellation aftermath. |
