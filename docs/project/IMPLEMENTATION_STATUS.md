...
| I023 | Standard `while` protocol | IN_PROGRESS | I023-A + I023-B published | D044 / spec `0.1.381` + D045 / spec `0.1.382`; B closed, I023-C READY |
...
| I023-C | READY | — | — | B is closed. Proceed in small slices through condition suspension, body suspension, cancellation/ensure, then repeated-suspension/bounded-state adversarial closure. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2 + DIST001-E3A published | DIST001-E3B is READY. Baseline/candidate/version remain unselected; no tag, GitHub Release, or release asset is authorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2 + DIST001-E3A published | E3 is subdivided into E3A-E3C. E3A closes release-mode build provenance; E3B is READY. Candidate-specific E4 still requires E3 closure plus explicit user selection. |
...
| DIST001-E3 | Release metadata, assets and validation preparation | IN_PROGRESS | DIST001-E3A published | E3A release-mode builder/provenance guards are closed; E3B is READY for notes/assets/checksum envelope; E3C remains dependency-blocked. No candidate/tag/Release selected. |
...
| DIST001-E3B | Release notes and asset/checksum manifest envelope | READY | — | Build deterministic generic release-note/asset metadata from explicit candidate context; preserve candidate-unselected and no-publication guards. |
| DIST001-E3C | Candidate validation entry point and E3 closure | BLOCKED_BY_DEPENDENCIES | — | Depends on E3B; compose release-mode archive/source identity, B5-equivalent extracted validation, notes/assets/checksums and release guards; close E3 and make E4 READY for explicit candidate selection. |
...
bounded E3A-E3C slices: E3A is closed and E3B is READY. The B5 gate remains the
reusable extracted-distribution conformance entry point and the D workflow
continuously publishes validated transient snapshots. No concrete release
