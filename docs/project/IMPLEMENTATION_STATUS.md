...
- public/distributed Group acquisition/discovery plus genuinely remote routing/transport acceptance uncertainty remain; language-visible GroupRef send/request and the complete local Group routing/backpressure/rerouting/concrete-acceptance/cancellation/retry/request-reply path are wired;
