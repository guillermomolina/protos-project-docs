...
| TOOL001-F2E | external immutable-package execution continuation | IN_PROGRESS | F2E0 CLOSED; F2E1 CLOSED | Canonical external ContentIdentity is frozen with fixed vectors; F2E2 verified store binding is BLOCKED by B009 portable Filesystem tree observation. |
...
| TOOL001-F2E2 | verified read-only package-store binding | BLOCKED | B009 | Parent F2E1 is CLOSED, but current Core Filesystem lacks the portable confined tree-observation/entry-kind/stable-snapshot contract required to verify protos-package-tree-v1 without a package-specific Java escape hatch. |
...
| Item | Description | Status | Closure evidence | Dependencies / notes |
|---|---|---|---|---|
| DIST001 | End-user distribution and release engineering | IN_PROGRESS | DIST001-A/B/C/D + DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C + DIST001-E4D1 published | Frozen candidate `957b1e16793a682de1d6406e37b5734c44d32d19` records and candidate-local bytes are independently consistent through D1. E4D2 release-aware B5 candidate gate is READY; publication remains unauthorized. |
...
| DIST001-E | First selected GitHub pre-release | IN_PROGRESS | DIST001-E1/E2/E3 + DIST001-E4A/E4B/E4C + DIST001-E4D1 published | E4D immutable validation is in progress; D1 consistency is closed and D2 release-aware B5 is READY. E5 remains dependency-blocked and separately requires publication authorization. |
...
| DIST001-E4 | Exact candidate selection and immutable validation | IN_PROGRESS | DIST001-E4A + DIST001-E4B + DIST001-E4C + DIST001-E4D1 published | Independent D1 cross-record/local-byte consistency PASS for candidate `957b1e16793a682de1d6406e37b5734c44d32d19` and exact artifact/envelope/audit digests. E4D2 READY; publication unauthorized. |
...
| DIST001-E4D | Immutable full candidate validation and E4 closure | IN_PROGRESS | DIST001-E4D1 published | D1 immutable record/local-byte consistency CLOSED; D2 extracted release-aware B5 candidate gate READY. |
...
| DIST001-E4D2 | Extracted release-aware B5 candidate gate | READY | — | Run the already-published release-aware B5 surface against exact candidate `957b1e16793a682de1d6406e37b5734c44d32d19` / `protos-0.2.236-posix-jvm.zip` after D1 consistency closure; do not duplicate D3 claim/spec audit. |
| DIST001-E4D3 | Candidate claims/blockers/spec audit | BLOCKED_BY_DEPENDENCIES | — | Depends on E4D2; re-audit frozen claims, B001-B008 and spec revision against exact candidate. |
| DIST001-E4D4 | Tag/Release collision + publication guard | BLOCKED_BY_DEPENDENCIES | — | Depends on E4D3; prove future tag/Release availability and publication=false before final validation. |
| DIST001-E4D5 | Full Maven + cross-E3/E4 validation | BLOCKED_BY_DEPENDENCIES | — | Depends on E4D4; perform final candidate/main validation and composed E3/E4 gate evidence. |
