...
| I023 | Standard `while` protocol | IN_PROGRESS | I023-A + I023-B + I023-C1 published | D044 / spec `0.1.381` + D045 / spec `0.1.382`; B + C1 closed, I023-C2 READY |
...
| I023-C | IN_PROGRESS | — | I023-C1 published | Condition suspension/replay is closed through repeated per-iteration suspension. C2 body suspension is READY; C3 cancellation/ensure and C4 repeated cross-phase/bounded-state closure remain dependency-gated. |
...
| I023-C2 | READY | — | — | C1 is closed. Exercise body `Future.value()` suspension/replay with exact-once effects in the same logical iteration. |
