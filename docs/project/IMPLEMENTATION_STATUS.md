...
| TOOL001-F2E1 | `protos-package-tree-v1` ContentIdentity canonical tree contract | READY | — | Freeze deterministic logical-tree inclusion/path/entry-kind/symlink/metadata/resource bytes and algorithm-tagged digest semantics before any external source root can become executable authority. |
