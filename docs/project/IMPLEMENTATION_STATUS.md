...
| I026 | Truffle tooling foundation | IN_PROGRESS | — | AUD002 hybrid Truffle-first architecture. A1/A2/A3/A4A/A4B1 are published. PLAT001 is RATIFIED; A4B2 is IN_PROGRESS with A4B2A/B2B1/B2B2 CLOSED and A4B2B3 IN_PROGRESS through mechanical A/B (A CLOSED, B READY). I026-D remains independently READY and A4B3 remains dependency-blocked. See docs/project/I026_TRUFFLE_TOOLING_FOUNDATION.md and docs/project/PLAT001_TRUFFLE_RUNTIME_HOSTING.md. |
...
| I026-A4B | Primary runtime-driver cutover | IN_PROGRESS | — | PLAT001 ratified; A4B1 multithread safety is published and A4B2 is IN_PROGRESS with only B2B3B remaining after frozen Core publication. A4B closes only after A4B3 completes production-driver cutover/legacy-entry retirement. |
...
| I026-A4B2 | Shared Engine + Process-scoped Context hosting | IN_PROGRESS | — | Refined mechanically into A4B2A-A4B2B; closes only after Process-scoped lifecycle and Actor/P/bootstrap integration are both published. |
...
| I026-A4B2B3 | Concurrent Core bootstrap closure | IN_PROGRESS | — | Mechanical A/B decomposition: A frozen Core publication is CLOSED; B A+ executable projection/final multi-Process closure is READY. |
...
| I026-A4B2B3B | A+ context-local executable projection + final concurrency closure | READY | — | PLAT001 A+; make globally shared source-backed root Closure executable plans Process-Context-local under EXCLUSIVE and prove no cross-Context CallTarget reuse/global guest lock; then close B010/B2B3/A4B2B/A4B2 and release A4B3. |
...
| I028 | Core networking foundation | IN_PROGRESS | — | D047 / specification `0.1.388` and D048 / specification `0.1.391` RATIFIED. A is mechanically subdivided into A1/A2/A3; A1 IpAddress local foundation is CLOSED, A2 is READY, and A3 remains dependency-gated. Later Network/TCP/backend/closure slices remain implementation work. `LIB005` stays blocked until I028 closes. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
| I028-A | Address/endpoint ordinary-object foundation | IN_PROGRESS | — | A1 IpAddress is published; A2 IpEndpoint is next; A3 Actor/P transfer closes A only after both local factories exist. |
...
| I028-A2 | IpEndpoint local foundation | READY | — | Implement only endpoint factory/validation/recognition/equality/hash/freeze/Prelude publication on top of closed A1. |
| I028-A3 | Actor/P transfer + A closure | BLOCKED_BY_DEPENDENCIES | — | Requires A2; prove ordinary transfer/rematerialization preserves canonical address/endpoint state and then close I028-A. |
...
| TOOL001-F2E3 | external-node execution-plan construction | READY | TOOL001-F2E2 CLOSED | Extend Protos-owned preflight only from exact registry/Git nodes whose immutable source custody has already passed the closed F2E2 same-capture verification gate. |
