...
| I028 | Core networking foundation | IN_PROGRESS | — | D047 / specification `0.1.388` and D048 / specification `0.1.391` RATIFIED; PLAT002 represented Network-capability architecture RATIFIED. I028-A is CLOSED. I028-B is IN_PROGRESS with B1/B2 CLOSED and B3 READY; C-F remain dependency-gated. `LIB005` stays blocked until I028 closes. See `docs/project/I028_NETWORKING_FOUNDATION.md`. |
...
| TOOL001-F2E4 | external canonical ModuleKey + source resolver | READY | `TOOL001-F2E3` CLOSED @ `0.2.310-SNAPSHOT` | Ready for generation-2 defensive host detach plus canonical external ModuleKey/source resolver and concrete run-local exact-package-identity to verified-custody mapping. |
