...
| PERF001-D | READY | Establish startup, warmup-curve and steady-state Protos measurements, including interpreter-versus-Truffle-compilation and non-timing compilation diagnostics, on top of the closed PERF001-C correctness gate. |
